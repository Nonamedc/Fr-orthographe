...
const OPS=[
  ...
  {id:'ponct',lbl:'Ponctuation',sub:'.,?!:;"()',ic:'❗',min:'CP'},
  {id:'defin',lbl:'Définitions',sub:'Comprendre les mots',ic:'📚',min:'CP'},
  {id:'niveau',lbl:'Niveau de langue',sub:'familier / courant / soutenu',ic:'🗣',min:'CM2'},
];
